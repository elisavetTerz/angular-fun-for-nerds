...
## Βήμα 4: Δημιουργία νέου component
 
- Δημιουργία ενός νέου component odd-length-component με την εντολή `ng generate component components/even-length`.
...
With event.preventDefault(); stop default page refreshing after submitting.
